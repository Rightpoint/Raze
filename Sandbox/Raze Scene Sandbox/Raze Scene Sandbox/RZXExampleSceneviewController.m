...
- (void)viewDidLoad
{
    ...
    RZXMesh *mesh = [RZXMesh meshWithName:@"firstMesh" meshFileName:@"marshmellow.mesh"];
    RZXStaticTexture *texture = [RZXStaticTexture textureWithFileName:@"rzMetal256.png" useMipMapping:YES useCache:YES];
